...
// // // // //         {tickets.map(ticket => (
// // // // //           <div key={ticket._id} className="bg-gray-200 p-4 rounded-md">
...
// // // // //         ))}
// // // // //       </div>
// // // // //       <button onClick={logout} className='bg-white border-2 border-white hover:bg-transparent transition-all text-indigo-700 hover:text-white font-semibold text-lg px-4 py-2 rounded duration-700 mt-4'>Logout</button>
// // // // //     </div>
// // // // //   );
// // // // // }
...
// // // //         {tickets.map(ticket => (
// // // //           <div key={ticket._id} className="bg-white shadow-md p-6 rounded-md">
// // // //             <h2 className="text-lg font-semibold mb-4">{ticket.key}</h2>
// // // //             <p>Type: {ticket.type}</p>
// // // //             <p>Summary: {ticket.summary}</p>
// // // //             <p>Description: {ticket.description}</p>
...
// // //       <div className="grid grid-cols-3 gap-4 p-8">
// // //         {tickets.map(ticket => (
// // //           <div key={ticket._id} className="bg-white shadow-md p-6 rounded-md cursor-pointer" onClick={() => toggleModal(ticket)}>
// // //             <p>Type: {ticket.type}</p>
// // //             <p>Summary: {ticket.summary}</p>
// // //             <p>Description: {ticket.description}</p>
...
// // //               <p>Summary: {selectedTicket.summary}</p>
// // //               <p>Description: {selectedTicket.description}</p>
// // //               <p>Status: {selectedTicket.status}</p>
// // //               <p>Reporter: {selectedTicket.reporter}</p>
// // //               <p>Due Date: {formatDate(selectedTicket.dueDate)}</p>
// // //               <p>Created Date: {formatDate(selectedTicket.createdDate)}</p>
// // //               <p>Updated Date: {formatDate(selectedTicket.updatedDate)}</p>
// // //               {/* Render additional details */}
// // //             </div>
// // //             <button onClick={toggleModal} className="bg-indigo-700 text-white font-semibold px-4 py-2 rounded-md mt-4 w-full">Close</button>
// // //           </div>
// // //         </div>
// // //       )}
// // //     </div>
// // //       <button onClick={() => setShowModal(true)} className="bg-indigo-700 text-white font-semibold px-4 py-2 rounded-full fixed bottom-8 right-8">Create Ticket</button>
// // //       {showModal && (
// // //         <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-500 bg-opacity-50">
// // //           <div className="bg-white p-8 rounded-md w-96">
...
// // //                 <input type="email" name="assigneeEmail" id="assigneeEmail" value={formData.assigneeEmail} onChange={handleInputChange} className="border-gray-300 rounded-md w-full" required />
// // //               </div>
// // //               <div className="mb-4">
...
// //   const handleSubmit = async (e) => {
// //     // Your submit logic for creating a ticket
// //   };
...
// //       <div className="grid grid-cols-3 gap-4 p-8">
// //         {tickets.map(ticket => (
// //           <div key={ticket._id} className="bg-white shadow-md p-6 rounded-md cursor-pointer" onClick={() => toggleTicketDetailsModal(ticket)}>
// //             <p>Type: {ticket.type}</p>
// //             <p>Summary: {ticket.summary}</p>
// //             <p>Description: {ticket.description}</p>
// //             <p>Status: {ticket.status}</p>
...
// //               {/* Render additional details */}
// //             </div>
// //             <button onClick={() => setShowTicketDetailsModal(false)} className="bg-indigo-700 text-white font-semibold px-4 py-2 rounded-md mt-4 w-full">Close</button>
// //           </div>
// //         </div>
// //       )}
...
// //           <div className="bg-white p-8 rounded-md w-96">
// //             <h2 className="text-xl font-semibold mb-4 text-center">Create Ticket</h2>
// //             {/* Your form for creating a ticket */}
// //             <form onSubmit={handleSubmit}>
// //               <div className="mb-4">
// //                 <label htmlFor="type" className="block text-sm font-medium text-gray-700">Type</label>
// //                 <select name="type" id="type" value={formData.type} onChange={handleInputChange} className="border-gray-300 rounded-md w-full" required>
